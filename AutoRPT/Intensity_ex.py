...
class IntensityMain:
    ...
    def Run(self, Wav_file_path, Textgrid_path, tier_name):
        ...
        data, error, error_arr = fp.iterateTextGridforIntensity(Textgrid_path, tier_name, Wav_file)
        ...
        csv_file = csv_no_ext + 'Intensity.csv'

        fo.to_csv(tier_arrays, csv_file)

        #print(full_complete_data)
